    ...
    <table style="width : 100%; table-layout:fixed;">
        <thead>
            <tr style="border: 2px solid;">
                <th style="border: 2px solid; width:10%;" class="text-center">Kode Pengembalian</th>
                <th style="border: 2px solid; width:8%;" class="text-center">Tanggal Pengembalian</th>
                <th style="border: 2px solid; width:9%;" class="text-center">Kode Peminjaman</th>
                <th style="border: 2px solid; width:9%;" class="text-center">NISN</th>
                <th style="border: 2px solid; width:10%;" class="text-center">Nama Anggota</th>
                <th style="border: 2px solid; width:9%;" class="text-center">Nominal Denda</th>
        ...
        <tbody>
            @foreach ($datapengembalian as $item)
                <tr>
                    ...
                    <td style="border: 2px solid;">{{ $item->tanggal_pengembalian }}</td>
                    <td style="border: 2px solid;">{{ $item->id_peminjaman }}</td>
                    <td style="border: 2px solid;">{{ $item->nisn }}</td>
                    <td style="border: 2px solid;">{{ $item->namaanggota }}</td>
                    <td style="border: 2px solid;">@currency($item->nominaldenda)</td>
