            ...
            <div class="card-body">
                ...
                @foreach ($datapengembalian as $item)
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="kode_peminjaman" value="{{ $item->id }}"
                            readonly>
                    </div>
                    <div class="form-group">
                        <label for="">NISN / Nama Anggota</label><br>
                        <input type="text" value="{{ $item->namaanggota }}" class="form-control" readonly>
                    </div>
                    <div class="form-group">
                        <label for="">Nominal Denda</label>
                        <input type="text" name="nominaldenda" value="{{ $item->nominaldenda }}" class="form-control"
                            readonly>
                    </div>
                @endforeach
                ...
                <div class="text-center mt-2">
                    <a href="{{ route('pengembalian') }}" type="button"
